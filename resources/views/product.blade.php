                        ...
                        <div class="form-holder">
                            <div class="form-content">
                                <div class="form-items">
                                    <h3>Product</h3>
                                    <form method="POST" action="add_product" class="requires-validation">
                                        @csrf 
                                        {{-- <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <input class="form-control" type="text" name="discription" placeholder="Product Discription" required>
                                        </div>
                                        {{-- {{dd($catagoriesArr)}} --}}
                                              ...
                                              <p>Select Categories</p>
                                                <div class="form-group">
                                                  <select name="categories[]" multiple placeholder="Choose skills" data-allow-clear="1">
                                                    ...
                                                    @foreach ($catagoriesArr as $category)
                                        ...
                                        <div class="form-button mt-3">
                                            <button id="submit" type="submit" class="btn btn-outline-primary">Add</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
